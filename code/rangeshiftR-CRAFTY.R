...
# Nick provided a zip file of the package, or to check for more recent versions, check that website, or email the team: RangeshiftR@uni-potsdam.de
library(Rcpp)
library(devtools)
Rcpp::evalCpp("2+2")
